...
if cfg.RISCV_ISA_BASE == "rv32i":
    ...
    cfg.CACHE_ACE_RESERVED_SIZE = 4 * 1024**2
    cfg.CACHE_ACE_RESERVED_START = None
    ...
    cfg.CACHE_ACE_RESERVED_START = 0xE0000000
    cfg.RISCV_ISA_EXTENSIONS_CPU0.append("svpbmt")
    cfg.RISCV_ISA_EXTENSIONS.append("svpbmt")
    if cfg.MEM_SIZE is None:
...
if cfg.CACHE_ACE_RESERVED_START is None or cfg.CACHE_ACE_RESERVED_START < cfg.MEM_START:
    cfg.CACHE_ACE_RESERVED_START = cfg.MEM_START + cfg.MEM_SIZE - cfg.CACHE_ACE_RESERVED_SIZE
cfg.CACHE_ACE_RESERVED_SIZE = cfg.MEM_START + cfg.MEM_SIZE - cfg.CACHE_ACE_RESERVED_START
cfg.CACHE_ACE_RESERVED_START_HEX = "{mem_start:x}".format(mem_start = cfg.CACHE_ACE_RESERVED_START)
cfg.CACHE_ACE_RESERVED_START_DT = gen_mem_size_dt(cfg.CACHE_ACE_RESERVED_START)
cfg.CACHE_ACE_RESERVED_SIZE_DT = gen_mem_size_dt(cfg.CACHE_ACE_RESERVED_SIZE)
cfg.CACHE_ACE_RESERVED_NODE = "cache-ace@" + cfg.CACHE_ACE_RESERVED_START_HEX
...
@CPU_MAP@
	...
	reserved-memory {
		...
		cache_ace_reserved: @CACHE_ACE_RESERVED_NODE@ {
			reg = <@CACHE_ACE_RESERVED_START_DT@ @CACHE_ACE_RESERVED_SIZE_DT@>;
			no-map;
		};
	};
